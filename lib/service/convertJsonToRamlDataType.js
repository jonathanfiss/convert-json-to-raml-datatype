...
module.exports = function convert(json, options) {
    ...
    var normalizeOutputType = normalizeType(output)
    var yamlOutput = yaml.dump(normalizeOutputType, json)
    var response = `#%RAML 1.0 DataType \n` + yamlOutput
    return response
}
...
function normalizeType(obj) {
    for (var prop in obj) {
      if (typeof obj[prop] === "object") {
        normalizeType(obj[prop]); // calls the function recursively for nested objects
      }
      if (prop === "type") {
